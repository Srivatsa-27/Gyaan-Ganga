							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										...
										<li>
											<a href="applied-jobs.php"><i class="fa fa-bookmark"></i> Applied Project</a>
										</li>
										<li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										...
										<ul class="footer-menu clearfix">
											...
											<li><a href="../employees.php">user</a></li>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Email : <a href="gyaangana@gmail.com">gyaangana@gmail.com</a></p>
								<p>Phone : <a href="tel:+9848032919">+91 9848032919</a></p>
