					...
					<div class="row">
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="job-detail-wrapper">
								...
								if ($myrole == "employee") {
                                print '<button';?> onclick="update(this.value)" <?php print ' value="'.$jobid.'" class="btn btn-primary btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-pencil"></i> Apply this project</button>';
								}else{
