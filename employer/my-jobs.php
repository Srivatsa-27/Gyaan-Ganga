							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										...
										<li>
											<a href="../company.php?ref=<?php echo "$myid"; ?>"><i class="fa fa-briefcase"></i> Profile Overview</a>
										</li>
										<li  class="active">
									...
									<?php
                                        ...
                                        foreach($result as $row)
                                        {
										   ...
										   ?>
											...
											<?php 
										    if ($logo == null) {
										     print '<center>project logo</center>';
										    }else{
										    echo '<center><img alt="image" title="'.$compname.'" width="180" height="100" src="data:image/jpeg;base64,'.base64_encode($logo).'"/></center>';	
										     }
										     ?>
											...
											<a href="edit-job.php?jobid=<?php echo $row['job_id']; ?>">Edit project</a>
											<a onclick = "return confirm('Are you sure you want to delete this job ?')" href="app/drop-job.php?id=<?php echo $row['job_id']; ?>">Delete Project</a>
											</div>
											</div>
				...
				<div class="main-footer">
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>Student collabrative platform</p>
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										...
										<ul class="footer-menu clearfix">
											...
											<li><a href="../employers.php">Project Hoster</a></li>
							...
							<h5 class="footer-title">Gyan Ganga</h5>
								
								<p>Address : Narapally</p>
								<p>Email : <a href="gyanganga@gmail.com">gyanganga@gmail.com</a></p>
								<p>Phone : <a href="tel:+91 9848032919">+91 9848032919</a></p>
