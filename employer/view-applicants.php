...
<head>
	...
	<title> Applicants for the Project <?php echo "$job_title"; ?></title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="./">Home</a></li>
						<li><span>Applicants for the Project	 <?php echo "$job_title"; ?></</span></li>
					</ol>
				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 class="sorting-title">Applicants for the project <?php echo "$job_title"; ?></</h3>
						</div>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : Narapally0</p>
								<p>Email : <a href="gyaanganga@gmail.com">gyaanganga@gmail.com</a></p>
