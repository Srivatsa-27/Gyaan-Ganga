...
<head>
	...
	<title>Project lists - <?php echo "$title"; ?></title>
										...
										<div class="content">
											...
											<div class="job-item-list-bottom">
												...
												<div class="row">
													...
													<div class="col-sm-5 col-md-4">
														<a target="_blank" href="explore-job.php?jobid=<?php echo $row['job_id']; ?>" class="btn btn-primary">View This project</a>
													</div>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : Narpally</p>
								<p>Email : <a href="">gyaanganga@gmail.com</a></p>
								<p>Phone : <a href="">9848032919</a></p>
